...
public class ControlHeaderListener extends MouseAdapter {
	
    JTableHeader   header;
    ControlModel    model;
    SortButtonRenderer renderer;
    
    public ControlHeaderListener(JTableHeader header, ControlModel model, SortButtonRenderer renderer) {
      this.header   = header;
      this.model    = model;
