...
public class OfflineUsersHeaderListener extends MouseAdapter {
	
    JTableHeader   header;
    OfflineUsersModel    model;
    SortButtonRenderer renderer;
    
    public OfflineUsersHeaderListener(JTableHeader header, OfflineUsersModel model, SortButtonRenderer renderer) {
      this.header   = header;
      this.model    = model;
