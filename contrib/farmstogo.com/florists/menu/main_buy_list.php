...
-->
  ...
  ?>
    <a href="javascript:OpenW('../include/popup_image.php?img=<?php echo "../stp_images/".$ft["image_file"]?>')">
...
<? if ($no_imgs) { ?>
<a href="javascript:OpenW('./d_images.php?st=<?echo $spx?>')"><img hspace=10  src="../s/imgs/viewall.gif" border=0></a>
<? } ?>
</font></td>
</tr>
         ...
         // echo "<form name=\"Buy_Product\" method=\"post\" action=\"\">";
          echo "<input type=\"hidden\" name=\"id_producto\" value=\"$id_producto_producto\">";
			...
			$xq++;
              ...
              echo "</select> <input type=\"image\" src=\"../s/imgs/ico_addcart.gif\"></font></div></td></tr>";
