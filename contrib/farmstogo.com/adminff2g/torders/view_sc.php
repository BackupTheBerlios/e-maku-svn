<script>
	function Empty() {
		window.location.href='empty_car.php';
	}	
	
	function AddCharge(){
		var charge
		charge = prompt("Write the amount for additional charge :","");		
		window.location.href='add_charge.php?charge='+charge;		
	}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
   <tr>
    ...
    <tr bgcolor="#CC3333">
    <td align="center" bgcolor="#CC3333"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">
...
#    $total_producto_shopping_cart=$price_producto_shopping_cart*$quantity_shopping_cart;
   ...
   if($design) { 
	...
	echo "<td align=center>".$quantity_shopping_cart."</td><td>\$".number_format($total_producto_shopping_cart,2)."</td>\n<td>\n";
    ...
    ?>
    <A href="javascript:show_calendar('select_date_<?echo $id_shotpping_cart?>.f1');">
	...
	echo "<td><a href=\"delete_producto_shopping_cart.php?ss=$session_id&id_shopping_cart=$id_shopping_cart\"><img src=../images/del.gif border=0></a></td></form></tr>\n";
}
 ...
 $grand_total_shopping_cart = $sub_total_productos_shopping_cart + $sub_total_day_charges + $subtotal_taxes+$surcharge;
 ...
 echo "<tr align=\"right\"><td colspan=3 align=\"left\"><b>Surcharge : </b></td><td>\$".number_format($surcharge,2)."</td><td></td></tr>\n";
 ...
 //echo "<form name=\"check_out\" target=_top method=\"post\" action=\"../../s/home/client_data_invoice.php\" OnSubmit=\"return validar(this)\">\n";
//echo $consulta_shopping_cart;
$script = <<< EOS
...
echo "<tr align='center'>";
	...
	$query = "SELECT id_user, full_name from s_users WHERE 1";
	$query .= " AND cod_type='ADMX'";
	$query .= " and id_user=".$_SESSION['idUserPoms'];
	if ($_SESSION['typeUser']==1){
		$query = "SELECT id_user, full_name from s_users ";
		$query .= "WHERE cod_type='ADMX'";
		} 
	$result = mysql_query($query);
	echo '<td colspan="3"><br><br>Salesperson: ' ;
