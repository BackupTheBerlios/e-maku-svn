...
#    $total_producto_shopping_cart=$price_producto_shopping_cart*$quantity_shopping_cart;
   ...
   if($design) { 
    ...
    echo "</td>";
    echo "<td align=right>$<input type=text name=price size=4 maxlength=7 value=\"".$price_producto_shopping_cart."\"></td>";
    ...
    echo "<td><a href=\"delete_producto_shopping_cart_nopublic.php?ss=$session_id&id_shopping_cart=$id_shopping_cart\"><img src=../images/del.gif border=0></a></td></form></tr>\n";
}
 ...
 echo "</table></td></tr>\n";
 echo "<form name=\"check_out\" target=_top method=\"post\" action=\"".SSL_HOST."client_data_invoice_nopublic.php\" OnSubmit=\"return validar(this)\">\n";
$script = <<< EOS
