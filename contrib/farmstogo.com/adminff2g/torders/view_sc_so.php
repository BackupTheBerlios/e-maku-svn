...
#    $total_producto_shopping_cart=$price_producto_shopping_cart*$quantity_shopping_cart;
   ...
   if($design) { 
	...
	echo "<td><a href=\"delete_producto_shopping_cart.php?ss=$session_id&id_shopping_cart=$id_shopping_cart&so=1\"><img src=../images/del.gif border=0></a></td></form></tr>\n";
}
 ...
 echo "<tr align=\"right\"><td colspan=3 align=\"left\"><b>Shippingsurcharge : </b></td><td>\$".$surcharge."</td><td></td></tr>\n";
...
/*     if($_SESSION['email']!='miguels@flowerdealers.com'){$query .=" AND email='".$_SESSION['email']."'";}
 *//* 	if($row_admin[0]=='ADC'){
