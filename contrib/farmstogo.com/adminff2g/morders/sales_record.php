...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="9"><h3>Sales Report (Orders in Status Delivered) <a href="javascript:print();">Print</a> </h3></td>
  </tr>
  <tr>
    <td colspan="9">&nbsp;</td>
  </tr>
...
o.FEDEX_CREDIT * -1
)FEDEX_CREDIT, o.COMMENTS, x.ORDER_STATUS, x.ID_ORDER_STATUS, MIN( i.ARRIVAL_DATE ) AS ARRIVAL_DATE, o.bankmessage, s_users.full_name AS SALES_PERSON
...
?>
      ...
      <?php $bgcolor="#FFFFFF";
		    $tvalue=$tqc_credit=$tfedex_credit=$tbalance=0;
		    do{ 
  ...
  <tr>
    <td colspan="9"><h3>Grand Total : <?php echo number_format($gtotal,2); ?></h3></td>
  </tr>
</table>
</body>
</html>
