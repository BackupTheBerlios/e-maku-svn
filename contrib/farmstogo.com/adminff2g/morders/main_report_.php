...
<A href="javascript:show_calendar('fecha.f2');"><IMG
   ...
   <td valign=top>Salesperson<br>
	...
	$pomsComm = mysql_connect("localhost", $POMS_USER, $POMS_PASS) or die("Error al conectarse a la DB");
...
$query = <<< EOM
	...
	MIN(i.ARRIVAL_DATE) as rd, o.DATE_TIME $campoFacVen FROM FACTURAS o, ITEMS_FACTURA i, COUNTRIES c, STATES s,
...
-->
<?
$rs = mysql_db_query($database,$query);
echo mysql_error();
