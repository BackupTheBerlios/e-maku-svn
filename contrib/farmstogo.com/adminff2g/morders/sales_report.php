...
$additwh="";
$kw=$ddate=$ddate2=$fechas=$IdVendedor="";
$status=0;
...
$sdate=$_POST['sdate'];
$additwh .= " AND o.DATE_TIME >= '$sdate' ";
 }
if(isset($_POST['sdate2']) && $_POST['sdate2']!="") {
$sdate2=$_POST['sdate2'];
$additwh .= " AND o.DATE_TIME <= '$sdate2'"; }
...
<body>
  <table border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    src="../images/calendario.gif"
    align=center border=0></A> </td>
            <td><input name="sdate2" type="text" id="sdate2" value="<?echo $sdate2; ?>" size="10" /></td>
    ...
    align=center border=0></A> </td>
            ...
            <td><select name="status" id="status">
              ...
              <?php SelecTable($database,'ORDERS_STATUS','ID_ORDER_STATUS',"ORDER_STATUS","","$status") ?>
            </select></td>
          </tr>
        </table>
            </form>	  </td>
    ...
    <tr>
	  ...
	  <table border="0" align="center" cellpadding="1" cellspacing="0" class="table">
		<?php if($totalRows){ ?>
        <tr>
          <td colspan="5"><div align="center"><a href="../reports.php">Go Back to Main Menu</a></div></td>
          </tr>
        <tr>
          <th>Order Id </th>
   ...
   <?php if($row_report["bankmessage"]){
    echo "<font color=brown >".$row_report["bankmessage"]."</font>";
        ...
        <tr valign="middle" class="<?php echo $class; ?>">
          <th colspan="5" align="center">Sorry, no information available for this feature. </th>
          </tr>
		<?php } ?>
		</table>  
	  </form></td>
