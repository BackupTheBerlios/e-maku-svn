...
&nbsp;&nbsp;	
	<select name="public">
				...
				<option value="2" <? if ($public==0) { echo " selected";} ?>>Public</option>
				<option value="1" <? if ($public==1) { echo " selected";} ?>>No Public</option>
...
//if ($public) { $spublic = " AND M.public=$public AND M.ID_MARKET=P.ID_MARKET"; }
