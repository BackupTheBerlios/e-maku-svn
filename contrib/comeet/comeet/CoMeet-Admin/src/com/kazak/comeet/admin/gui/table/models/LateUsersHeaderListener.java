...
public class LateUsersHeaderListener extends MouseAdapter {
	
    JTableHeader   header;
    LateUsersModel    model;
    SortButtonRenderer renderer;
    
    public LateUsersHeaderListener(JTableHeader header, LateUsersModel model, SortButtonRenderer renderer) {
      this.header   = header;
      this.model    = model;
