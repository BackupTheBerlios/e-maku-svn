...
public class EmakuUIFieldFiller extends Thread {
    ...
    public EmakuUIFieldFiller(GenericForm GFforma,String namebutton,boolean ok_search,
    ...
    public EmakuUIFieldFiller(GenericForm GFforma,String sql,String arg,XMLTextField[] XMLTFout) {
		this.GFforma=GFforma;
		this.sql=sql;
		this.arg=arg;
