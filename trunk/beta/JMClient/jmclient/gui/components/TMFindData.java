...
implements ChangeValueListener,InitiateFinishListener, ChangeExternalValueListener{
    ...
    public Element getUVPackage() throws ErrorDataException {
        ...
        int valorDef = 0;
        /*
         * Variable encargada de verificar por lo menos un factor de conversiï¿½n
         * en el producto.
         */
        boolean factor = false;
        /*
         * Se recorre toda la tabla buscando factores de conversiï¿½n
         */
        ...
        for (int i=0;i<rows; i++) {
            ...
            /*
             * Si el valor del factor de conversiï¿½n es diferente de 0 es
             * porque existe un nuevo factor de conversiï¿½n.
             */
            if (!getValueAt(i,4).toString().equals("0.0")) {
	            for (int j=0;j<getColumnCount();j++) {
	            	/*
	            	 * Se ordena la informaciï¿½n deacuerdo a su orden de retorno
                    ...
                    /*
                     * Validaciï¿½n encargada de verificar la existencia de un solo
                     * valor por defecto
                     */
        ...
        /*
         * Se verifica que existan factores de conversiï¿½n en el producto
         */
