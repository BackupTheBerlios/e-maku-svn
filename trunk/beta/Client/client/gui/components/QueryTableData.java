 ...
 */
public class QueryTableData extends AbstractTableModel {
     ...
     */
    public QueryTableData(String sql) {
     ...
     */
    public QueryTableData(String sql,String[] args) {
    ...
    private void searchQuery(String sql,String[] args) {
        try {
            Document Dquery;
            if (args!=null) 
                Dquery = STResultSet.getResultSetST(sql,args);
            else
                Dquery = STResultSet.getResultSetST(sql);
