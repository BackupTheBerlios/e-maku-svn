...
//		validCols = new Hashtable();
        ...
        while (i.hasNext()) {
             ...
             */
	            	...
	            	while (j.hasNext()) {
	            		...
	            		System.out.println("Adicionando: "+f.getValue());
	...
	throws SQLNotFoundException, SQLBadArgumentsException, SQLException, DontHaveKeyException {
		 ...
		 * 
		 * Otra informaciï¿½n que debe estar cacheada son los asientos predefinidos de cada producto.
		 * 
		 */
		
		/*
		 * El proceso que se lleva para la generaciï¿½n de un asiento contable es el siguiente:
		 */
					...
					if (baseAccount>=base) {
						 ...
						 */
							...
							if (CacheEnlace.isPCInventarios(bd,attribute)) {
								 ...
								 */
								if (colCost==col) {
									System.out.println("generando por costo de producto");
									System.out.println("columna: "+valueAccount+" costo: "+CacheEnlace.getPCosto(bd,CacheKeys.getKey("idBodega"),idProdServ)+" cantidad * costo: "+valueAccount*CacheEnlace.getPCosto(bd,CacheKeys.getKey("idBodega"),idProdServ));
									valueAccount = valueAccount * CacheEnlace.getPCosto(bd,CacheKeys.getKey("idBodega"),idProdServ);
									System.out.println("variable valueAccount: "+valueAccount);
