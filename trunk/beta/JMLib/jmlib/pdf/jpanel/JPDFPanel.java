 ...
 * 
 */
public class JPDFPanel extends JFrame {
...
//		topBar.add(pageChanger);
	...
	private JButton initOpenBut() {
		...
		open.setIcon(new ImageIcon(getClass().getResource("/jmlib/pdf/pdfviewer/res/open.gif"))); //$NON-NLS-1$
		open.setText("Open");
	...
	private Component[] initChangerPanel(){
		...
		URL startImage =getClass().getResource("/jmlib/pdf/pdfviewer/res/start.gif"); 
...
//		currentBar1.add(start);
		...
		URL fbackImage =getClass().getResource("/jmlib/pdf/pdfviewer/res/fback.gif");
...
//			    	set page number display
		...
		URL backImage =getClass().getResource("/jmlib/pdf/pdfviewer/res/back.gif"); 
...
//		currentBar1.add(pageCounter3);
		...
		URL fowardImage =getClass().getResource("/jmlib/pdf/pdfviewer/res/forward.gif");
...
//				set page number display
		...
		URL ffowardImage =getClass().getResource("/jmlib/pdf/pdfviewer/res/fforward.gif");
...
//				set page number display
		...
		URL endImage =getClass().getResource("/jmlib/pdf/pdfviewer/res/end.gif");
